...
class WritemarkEditorElement extends HTMLElement {
  ...
  _installBuiltInActions() {
    ...
    for (let level = 1; level <= 4; level += 1) r({ id: `block.heading.${level}`, label: `Heading ${level}`, description: `Convert to heading level ${level}`, group: "Blocks", aliases: [`h${level}`, `heading${level}`], keywords: ["title", "section"], defaultShortcut: level <= 3 ? `Mod+Alt+${level}` : undefined, visibleInSlash: true, run: ctx => this._toggleHeading(ctx, level) });
    ...
    r({ id: "inline.underline", label: "Underline", description: "Underline text", group: "Inline", aliases: ["underline", "u"], defaultShortcut: "Mod+U", visibleInSlash: true, run: ctx => this._wrapInline(ctx, "_", "_", "Underline") });
    ...
    r({ id: "inline.superscript", label: "Superscript", description: "Superscript text", group: "Inline", aliases: ["superscript", "sup"], visibleInSlash: true, run: ctx => this._wrapInline(ctx, "^", "^", "Superscript") });
    r({ id: "inline.highlight", label: "Highlight", description: "Highlight text", group: "Inline", aliases: ["highlight", "mark"], defaultShortcut: "Mod+Shift+H", visibleInSlash: true, run: ctx => this._wrapInline(ctx, "==", "==", "Highlight") });
    r({ id: "inline.secret", label: "Secret", description: "Hidden click-to-reveal text", group: "Inline", aliases: ["secret", "spoiler", "hidden"], visibleInSlash: true, run: ctx => this._wrapInline(ctx, "#", "#", "Secret") });
